...
public interface IEnrollmentService
{
    ...
    ValueTask<GetAllEnrollmentResponse> GetAllEnrollmentsAsync(GetAllEnrollmentRequest request, CancellationToken cancellationToken);
    ValueTask<GetAllEnrollmentByElectiveYearResponse> GetAllEnrollmentsByElectiveYearAsync(GetAllEnrollmentByElectiveYearRequest request, CancellationToken cancellationToken);
