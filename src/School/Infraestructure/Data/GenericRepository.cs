...
namespace Infraestructure.Data
{
    public class GenericRepository<T> where T : class, IAggregateRoot
    {
        ...
        public GenericRepository(ILogger<GenericRepository<T>> logger, SchoolDbContext context, ISpecificationEvaluator specificationEvaluator)
        {
            _logger = logger;
            _context = context;
        ...
        /// <param name="logger">logger application</param>
        /// <param name="context">context application</param>
        public GenericRepository(ILogger<GenericRepository<T>> logger, SchoolDbContext context): this(logger, context, SpecificationEvaluator.Default) { }
