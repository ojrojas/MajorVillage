...
public static class UserApplicationGroupRoute
{
    ...
    {
        return
                group.MapPatch("UpdateUserApplication", [Authorize(AuthenticationSchemes = OpenIddictValidationAspNetCoreDefaults.AuthenticationScheme)]
    ...
    {
        return
                group.MapDelete("DeleteUserApplication/{Id}", [Authorize(AuthenticationSchemes = OpenIddictValidationAspNetCoreDefaults.AuthenticationScheme)]
    ...
    {
        return
                group.MapPost("CreateUserApplication", [Authorize(AuthenticationSchemes = OpenIddictValidationAspNetCoreDefaults.AuthenticationScheme)]
