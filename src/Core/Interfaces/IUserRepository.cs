...
public interface IUserRepository
{
    ...
    Task<User> GetUserByIdAsync(object id, CancellationToken cancellationToken);
    Task<IEnumerable<User>> ListUserAsync(IPredicate predicate, CancellationToken cancellationToken);
